...
Very early on it was decided that an interface was not appropriate for this project, as the quadtree implementation would never change so substantially that the supported methods would be affected. Therefore for ease of work and ease of reading the interface was abandoned altogether. The quadtree is implemented simply in quadtree.cpp and quadtree.h
